...
class Load:
    ...
    def load(self):
        ...
        self.playerList[0].color = player1_color
        ...
        self.playerList[1].color = player2_color
        ...
        if num_players > 1:
            ...
            self.playerList[2].color = player3_color
        ...
        if num_players > 2:
            ...
            self.playerList[3].color = player4_color
